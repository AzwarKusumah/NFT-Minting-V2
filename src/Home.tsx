            ...
            <MainContainer>
                <WalletContainer>
                    ...
                    <Menu>
                        ...
                        <li><a href="/" target="_blank"
                               rel="noopener noreferrer">LAUNCHPAD</a></li>
                    </Menu>
                    <Wallet>
                        {wallet ?
                ...
                <ShimmerTitle>PRISONWORLDS MINT IS LIVE !</ShimmerTitle>
                <br/>
                ...
                <MintContainer>
                    <DesContainer>
                        <NFT elevation={3}>
                            <GoldTitle>PRISONWORLDS NFT</GoldTitle>
                            <br/>
                            <div><Price
                    ...
                    <DesContainer>
                        <Des elevation={2}>
                            <LogoAligner><img src="logo.png" alt=""></img><GoldTitle>PRISONWORLDS</GoldTitle></LogoAligner>
                            <Para>Prison Worlds is a 785 3D NFT collection that brings real utilities for the holder.</Para>
                            <Para>Prison Worlds offer a launchpad service for all those who want to launch their NFT Project.</Para>
                            <Para>Mount Weather is a mysterious prison in the world because it is the most famous place.</Para>
                        </Des>
                    </DesContainer>
                    <DesContainer>
                        <Des elevation={2}>
                            <LogoAligner><img src="logo.png" alt=""></img><GoldTitle>WHAT ARE WE DOING?</GoldTitle></LogoAligner>
                            <Para>You just provide only png or jpg for us. We will generate Image and Metadata for you.</Para>
                            <Para>We will help you to create your own mint webpage with your own brand domain name.</Para>
                            <Para>Low fees make it easy to make your project with the best results.</Para>
                        </Des>
                    </DesContainer>
                    <DesContainer>
                        <Des elevation={2}>
